...
- 🦘 **Slime Bounce** — Bounce off blocks like a slime (10+ stacks)
- 💥 **Shockwave** — Create a shockwave on landing from heights (25+ stacks)
- 📏 **Character Growth** — Your character grows with oversaturation
- ⚖️ **Scales Block** — Redstone-compatible weight measurement block
- 🎨 **Custom HUD** — Burger counter, fat hearts, and stats panel
- 🔧 **Fully Configurable** — 50+ configuration options
...
| Stack | Effect |
|-------|--------|
| 1+ | Movement slowdown, attack damage bonus, knockback resistance |
| 10+ | **Slime Bounce** ability unlocked |
...
You may:
- ✅ Use this mod in your modpacks (with credit)
- ✅ Use this mod in videos/streams (with credit)
- ✅ Report bugs and suggest features

You may not:
- ❌ Redistribute the mod file without permission
...
Made with ❤️ by [MakCane](https://www.patreon.com/c/MakCane)
